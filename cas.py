...
signup_window.geometry("730x640+400+100")
...
signup_window_btn_back = Button(signup_window, text="BACK", borderwidth=10,font=("Calisto MT", 20, "bold"), command=back_signup,bg = "dark blue",fg="white")
signup_window_btn_signup = Button(signup_window, text="DONE", borderwidth=10,font=("Calisto MT", 20, "bold"), command=done_signup,bg = "dark blue",fg ="white")
...
main_window_lbl_qotd.place(x=10, y=600)"""
...
weather_window.geometry("700x510+400+100")
...
weather_window_btn_search.place(x=260, y=220)
weather_window_lbl_result.place(x=200, y=320)
...
corona_window_btn_search.place(x=260, y=220)
...
bitcoin_window_btn_search = Button(bitcoin_window , text = "SEARCH" ,borderwidth=10, font = ("calisto mt", 18 , "bold"),bg = "grey",fg = "black",command = search_bitcoin)
bitcoin_window_lbl_result = Label(bitcoin_window ,font = f , textvariable = bitcoin_result,bg = "black",fg="white")
bitcoin_window_btn_back = Button(bitcoin_window, text="BACK", borderwidth=10, font=("calisto mt", 18 , "bold"), bg = "grey",fg = "black" , command = back_bitcoin)
bitcoin_window_btn_refresh = Button(bitcoin_window, text="REFRESH", borderwidth=10, font=("calisto mt", 18 , "bold"),command = refresh_bitcoin,bg = "grey",fg = "black")
...
news_window_st_data = ScrolledText(news_window,width = 46,height = 15 , font = ('calisto mt', 20, 'bold'),wrap = WORD, bg = "black",fg="white")
